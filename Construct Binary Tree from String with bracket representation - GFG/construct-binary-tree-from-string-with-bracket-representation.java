...
class Solution {
    ...
    //
    public static Node construct(String str,int start,int end){
        ...
        if(start <= end && str.charAt(start) == '('){
            index = balanceParenthesis(str,start,end);
    ...
    //
    // Firstly we will make a group of balance parenthesis means range
    
    static int balanceParenthesis(String str,int start,int end){
